/*
 * ============================================================
 * Estación Ambiental Inteligente - Iquitos v2.5
 * v2.4 (calibración + MQTT) + comandos remotos + WiFiManager
 * ============================================================
 */
...
void setup() {
  ...
  delay(500);
  Serial.println();
  Serial.println("=== Estacion Ambiental Iquitos v2.5 (comandos + WiFiManager) ===");
